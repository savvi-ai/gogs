LDFLAGS += -X "github.com/savvi-ai/gogs/internal/conf.BuildTime=$(shell date -u '+%Y-%m-%d %I:%M:%S %Z')"
LDFLAGS += -X "github.com/savvi-ai/gogs/internal/conf.BuildCommit=$(shell git rev-parse HEAD)"
